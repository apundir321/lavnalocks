...
async function seedDB() {
  ...
  await seedCateg("L-A15",4999,"/assets/img/LA15/1.jpg",3899,"Meet the 2 in 1 MOST Affordable Digital door lock from LAVNA Locks, which you can access from your fingerprint and Key.",null,"features-L-A15");
  await seedCateg("L-H300",7500,"/assets/img/LH300/2.jpg",3980,"Meet the 2 in 1 smart lock for hotel doors from LAVNA Locks, which you can access from your RFID Card and Key.",null,"features-L-H300");
  await seedCateg("L-A5",13900,"/assets/img/LA5/1.jpg",8700,"Meet the 4 in 1 Glass door security lock from LAVNA Locks, which you can access from your fingerprint, RFID Card, PIN and remote",null,"features-L-A5");
  ...
  await seedCateg("L-A24(WI-FI)",15700,"/assets/img/la24/2.jpg",9800,"Meet the 5 in 1 Digital door lock from LAVNA Locks, which you can access from your fingerprint, RFID Card, PIN, WI-FI unlocking and manual key.",null,"features-L-A24(WI-FI)");
  await seedCateg("L-A24-Black(Bluetooth)",14200,"/assets/img/la24/1_bluetooth.jpg",8300,"Meet the 6 in 1 Digital door lock from LAVNA Locks, which you can access from your fingerprint, RFID Card, PIN, Bluetooth unlocking, OTP Unlocking and Key.",null,"features-L-A24-Black(Bluetooth)");
  await seedCateg("L-A24-Black(WI-FI)",15700,"/assets/img/la24/3.jpg",9800,"Meet the 5 in 1 Digital door lock from LAVNA Locks, which you can access from your fingerprint, RFID Card, PIN, WI-FI unlocking.",null,"features-L-A24-Black(WI-FI)");
  ...
  await seedCateg("L-A28(WI-FI)",9999,"/assets/img/LA28_gold/9.jpg",8700,"Meet the 6 in 1 Lock for your doors from LAVNA Locks, which you can access from your Fingerprint, PIN, RFID card, OTP unlocking, WI-FI unlocking and Manual Key.",null,"features-L-A28(WI-FI)");
  ...
  await seedCateg("L-A28-Black(Bluetooth)",8999,"/assets/img/L-A28.jpg",7600,"Meet the 6 in 1 Lock for your doors from LAVNA Locks, which you can access from your Fingerprint, PIN, RFID card, OTP unlocking, Bluetooth unlocking and Manual Key.",null,"features-L-A28-Black(Bluetooth)");
