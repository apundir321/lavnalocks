...
// ],"features-L-A24-GOLD");
  ...
  await seedCateg("L-A24-GOLD",14200,"../../assets/new_assets/images/LA24-gold_1.jpg",10999,"Meet the 6 in 1 Fingerprint door lock from LAVNA Locks, which you can access from your fingerprint, RFID Card, PIN, Bluetooth unlocking, OTP Unlocking and Key.",null,"features-L-A24-GOLD");
  await seedCateg("L-A24-Black(Bluetooth)",14200,"/assets/img/la24/1_bluetooth.jpg",10999,"Meet the 6 in 1 Digital door lock from LAVNA Locks, which you can access from your fingerprint, RFID Card, PIN, Bluetooth unlocking, OTP Unlocking and Key.",null,"features-L-A24-Black(Bluetooth)");
  ...
  await seedCateg("L-A28-Black(Bluetooth)",8999,"/assets/img/L-A28.jpg",7999,"Meet the 6 in 1 Lock for your doors from LAVNA Locks, which you can access from your Fingerprint, PIN, RFID card, OTP unlocking, Bluetooth unlocking and Manual Key.",null,"features-L-A28-Black(Bluetooth)");
