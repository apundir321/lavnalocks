...
async function seedDB() {
  ...
  await seedCateg("L-H300",7500,"/assets/img/LH300/2.jpg",4300,"Meet the 2 in 1 smart lock for hotel doors from LAVNA Locks, which you can access from your RFID Card and Key.",null,"features-L-H300");
  ...
  await seedCateg("L-A24(WI-FI)",15700,"/assets/img/la24/2.jpg",9800,"Meet the 5 in 1 Digital door lock from LAVNA Locks, which you can access from your fingerprint, RFID Card, PIN, WI-FI unlocking.",null,"features-L-A24(WI-FI)");
  ...
  await seedCateg("L-A28(WI-FI)",9999,"/assets/img/LA28_gold/9.jpg",8700,"Meet the 6 in 1 Lock for your doors from LAVNA Locks, which you can access from your Fingerprint, PIN, RFID card, OTP unlocking, Bluetooth unlocking and Manual Key.",null,"features-L-A28(WI-FI)");
