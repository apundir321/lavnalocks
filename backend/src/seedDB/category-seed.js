...
// ],"features-L-A24-GOLD");
  ...
  await seedCateg("L-A28-GOLD",8999,"/assets/img/lavna6.jpg",7799,"Meet the 6 in 1 Fingerprint door lock from LAVNA Locks, which you can access from your fingerprint, RFID Card, PIN, Bluetooth unlocking, OTP Unlocking and Key.",null,"features-L-A28-GOLD");
  ...
  await seedCateg("L-H300",7500,"/assets/img/LH300/2.jpg",3850,"Meet the 2 in 1 smart lock for hotel doors from LAVNA Locks, which you can access from your RFID Card and Key.",null,"features-L-H300");
  await seedCateg("L-A5",13900,"/assets/img/LA5/1.jpg",8599,"Meet the 4 in 1 Glass door security lock from LAVNA Locks, which you can access from your fingerprint, RFID Card, PIN and remote",null,"features-L-A5");
  ...
  await seedCateg("L-A24-GOLD",14200,"/assets/img/lavna6.jpg",9499,"Meet the 6 in 1 Fingerprint door lock from LAVNA Locks, which you can access from your fingerprint, RFID Card, PIN, Bluetooth unlocking, OTP Unlocking and Key.",null,"features-L-A24-GOLD");
  await seedCateg("L-A24-Black(Bluetooth)",14200,"/assets/img/la24/1_bluetooth.jpg",9499,"Meet the 6 in 1 Digital door lock from LAVNA Locks, which you can access from your fingerprint, RFID Card, PIN, Bluetooth unlocking, OTP Unlocking and Key.",null,"features-L-A24-Black(Bluetooth)");
  ...
  await seedCateg("L-A28-Black(Bluetooth)",8999,"/assets/img/L-A28.jpg",7799,"Meet the 6 in 1 Lock for your doors from LAVNA Locks, which you can access from your Fingerprint, PIN, RFID card, OTP unlocking, Bluetooth unlocking and Manual Key.",null,"features-L-A28-Black(Bluetooth)");
