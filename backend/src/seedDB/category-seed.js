...
async function seedDB() {
  ...
  await seedCateg("L-A28-Black(Bluetooth)",8999,"/assets/img/L-A28.jpg",7699,"Meet the 6 in 1 Lock for your doors from LAVNA Locks, which you can access from your Fingerprint, PIN, RFID card, OTP unlocking, Bluetooth unlocking and Manual Key.",null,"features-L-A28-Black(Bluetooth)");
